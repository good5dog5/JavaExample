...
//                obj = setter(obj, "CutRate", areaDouble, double.class);
    ...
    public static  <T> void formatedTODesiredFormat(Object obj, Class<T> classType) throws IllegalAccessException, InstantiationException {
        ...
        if(isObjectContainField(obj, "thickness")) {
            String thickness = Objects.requireNonNull(getter(obj, "Thickness")).toString();
    ...
    public Object changeToDesiredFormat(Object obj) throws IllegalAccessException, InstantiationException {
    ...
    public static void setter(Object obj, String fieldName, Object value, Class<?> type) {
        try {
            Method met = obj.getClass().getDeclaredMethod("set" + fieldName, type);
    ...
    public static Object getter(Object obj, String fieldName) {
        try {
            Method met = obj.getClass().getDeclaredMethod("get" + fieldName);
